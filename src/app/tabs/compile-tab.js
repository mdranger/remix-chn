...
module.exports = class CompileTab {
  ...
  render () {
    ...
    self._view.compileButton = yo`<div class="${css.compileButton}" onclick=${compile} id="compile" title="Compile source code">${self._view.compileIcon} 开始编译 (Ctrl-S)</div>`
    ...
    self._view.compileContainer = yo`
      <div class="${css.compileContainer}">
        <div class="${css.info}">
          <span>当前编译器版本:</span> ${self._view.version}
          <div class="${css.crow}">
          ...
          <div class="${css.compileButtons}">
            <div class=${css.checkboxes}>
              ...
              <div class="${css.optimizeContainer}">
                ...
                <label for="optimize" class="${css.checkboxText}">编译优化</label>
              </div>
              <div class=${css.hideWarningsContainer}>
                ${self._view.hideWarningsBox}
                <label for="hideWarningsBox" class="${css.autocompileText}">略过警告</label>
              </div>
            </div>
    ...
    self._view.contractEl = yo`
      <div class="${css.container}">
        ...
        <div class="${css.contractHelperButtons}">
          <div title="Display Contract Details" class="${css.details}" onclick=${details}>详细内容</div>
  ...
  _updateVersionSelector () {
    ...
    self._view.versionSelector.appendChild(yo`<option disabled selected>选择编译器版本</option>`)
